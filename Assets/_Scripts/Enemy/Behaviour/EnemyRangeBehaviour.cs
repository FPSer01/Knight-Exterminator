...
public class EnemyRangeBehaviour : BaseEnemyBehaviour
{
    [Header("Range Behaviour: General")]
    ...
    [Header("Range Behaviour: Behaviour Options")]
    ...
    private EnemyRangeAttack enemyAttack => enemyComponents.Attack as EnemyRangeAttack;
    ...
    private bool Attack()
    {
        ...
        if (DoOnce())
        {
            var targetPosition = CalculatePredictedPosition(currentTarget, enemyAttack.ProjectileSpeed);

            enemyAttack.RangeAttack(targetPosition);
        }
